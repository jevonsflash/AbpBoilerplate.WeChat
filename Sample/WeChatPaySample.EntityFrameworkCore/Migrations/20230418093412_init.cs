...
namespace WeChatPaySample.Migrations
{
    /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenantId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: false, comment: "关联用户"),
                    OrderNumber = table.Column<string>(type: "nvarchar(19)", maxLength: 19, nullable: true, comment: "订单号"),
                    TradeNo = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "交易单号"),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "订单状态"),
                    ErrorMessage = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "错误描述"),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "订单类型"),
                    Payment = table.Column<decimal>(type: "decimal(18,2)", nullable: true, comment: "订单价格"),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "交易完成时间"),
                    Body = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "交易名称"),
