...
namespace WeChatPaySample.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly WeChatPaySampleDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = WeChatPaySampleConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(WeChatPaySampleDbContext context)
        {
            _context = context;
        }
