...
using WeChat.Official.Services.MediaManagement.Request;
using WeChat.Official.Services.MediaManagement.Response;

namespace WeChat.Official.Services.MediaManagement
{
    /// <summary>
    /// 素材管理相关服务接口定义。
    /// </summary>
