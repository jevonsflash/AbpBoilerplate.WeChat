...
namespace WeChat.Official.Services.CustomMenu
{
    /// <summary>
    /// 自定义菜单的模型定义。
    /// </summary>
    public class CustomButton
    {
        ...
        /// 类型为: <see cref="CustomButtonType.View"/> 或 <see cref="CustomButtonType.Official"/> 时必填。
        /// </summary>
        /// <remarks>
        /// 当 <see cref="Type"/> 类型为 <see cref="CustomButtonType.Official"/> 时，不支持小程序的老版本客户端将打开本 URL。
        /// </remarks>
        [JsonProperty("url")]
        ...
        /// 类型为: <see cref="CustomButtonType.Official"/> 时必填。
        /// </summary>
        [JsonProperty("appid")]
