...
using WeChat.Official.Services.TemplateMessage.Request;
using WeChat.Official.Services.TemplateMessage.Response;
using Newtonsoft.Json;

namespace WeChat.Official.Services.TemplateMessage
{
    /// <summary>
    ...
    public class TemplateMessageService : CommonService
    {
        ...
        public Task<SendMessageResponse> SendMessageAsync(string openId,
            ...
            OfficialRequest miniProgramRequest = null)
        {
